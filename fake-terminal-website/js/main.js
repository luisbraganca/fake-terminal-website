...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "The OpenDNA Projects now uses a unix-inspired pseudo-terminal interface. Type 'help' for a list of basic commands.\n",
...
var files = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        "github.txt": "https://github.com/mckinnon",
        "welcome_message.txt": "The OpenDNA Projects now uses a unix-inspired pseudo-terminal interface. Type 'help' for a list of basic commands.\n"
    };
    return {
        getInstance: function (options) {
            instance === void 0 && (instance = new Singleton(options));
